...
class ThreeDofPhysics:
    ...
    def calculate_actuator_forces(self, input_angle, thrust, vehicle, time_step, print_warnings=False):
        ...
        if angle_change_rate > vehicle.servo_rate_lim:
            input_angle = self.last_input_angle - vehicle.servo_rate_lim * time_step
            if print_warnings:
        ...
        torque = np.sin(input_angle) * thrust * vehicle.com2TVC
