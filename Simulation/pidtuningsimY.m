...
tferY = -1*idtf(sysY); % added a -1 to try to do something


% Specify target tuning parameters
target_wc = 2.7; % Target crossover frequency (rad/s)
target_pm = 55;  % Target phase margin (degrees)
...
writetable(data_table, 'closed_loop_simulationY.csv');
...
writetable(metrics_table, 'closed_loop_metricsY.csv');

disp('Simulation data saved to closed_loop_simulationY.mat and closed_loop_simulationY.csv');
disp('Performance metrics saved to closed_loop_metricsY.csv');