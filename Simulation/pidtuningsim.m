...
sysX = ssest(inputX, outputX, 4, 'Ts', Ts);
sysY = ssest(inputY, outputY, 4, 'Ts', Ts);
...
writetable(data_table, 'closed_loop_simulation.csv');
...
writetable(metrics_table, 'closed_loop_metrics.csv');

disp('Simulation data saved to closed_loop_simulation.mat and closed_loop_simulation.csv');
disp('Performance metrics saved to closed_loop_metrics.csv');